...
import { generatePlayerBio } from '../services/puterService';
...
const CreatePlayer: React.FC<CreatePlayerProps> = ({ onPlayerCreate, onOpenSettingsModal, onBack }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto animate-fade-in relative">
            <div className="absolute top-0 right-0 flex items-center gap-2">
                <button onClick={onOpenSettingsModal} title="Settings" className="text-gray-400 hover:text-white transition-colors p-2 z-10">
